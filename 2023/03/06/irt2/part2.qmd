...
In [Part I][PI], we went through the simplest item
...
DAG on the right below is identical to the one in [Part I][PI] (the left
...
[Part I][PI]. The brackets here serve a similar function to R's subset function
...
the important things through the logistic back in [Part I][PI]. I mention
