...
variable $O_j$ reprsents the origin of the judge (French or non-French). 
$O_w \rightarrow R$ indicates an undesired influence on the rating: the origin
of the wine, in addition to its quality, influence the rating score it receives.
The arrow from $O_j$ pointing down to $O_w \rightarrow R$ represents the wine
origin's influence on the rating is moderated by the origin of the judge. Put
it another way, there is an interaction between $O_w$ and $O_j$. This is likely,
...
undesired effects of $O_w$ on $R$ is estimable within the IRT framework by 
